...
describe('Petriflow integration tests', () => {
  ...
  function assertCorrectImport(model) {
    ...
    expect(t5DataGroup.getDataRef('newVariable_5').logic.required).toBeFalse();
    ...
    expect(t5DataGroup.getDataRef('newVariable_9').logic.required).toBeTrue();
    ...
    expect(t5DataGroup.getDataRef('newVariable_10').logic.required).toBeTrue();
  ...
  test.only('should import & export', (done) => {
